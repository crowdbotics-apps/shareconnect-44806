"""
Django settings for shareconnect_44806 project.
...
ROOT_URLCONF = 'shareconnect_44806.urls'
...
WSGI_APPLICATION = 'shareconnect_44806.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shareconnect_44806 API",
    "DESCRIPTION": "API documentation for shareconnect_44806 App",
    "VERSION": "v1",
}
